...
<tr>
  <td><a href = "https://github.com/Shazy021/Triton_yolov8-seg">Triton_yolov8-seg</a></td>
  <td>Triton, Docker, YoloV8(Segmentation), Numpy, OpenCV, Onnx</td>
  <td>Пример использования Triton Inference Server для задач инстанс сегментации.</td>
  <td>Завершен</td>
</tr>
...
<tr>
  <td><a href = "https://github.com/Shazy021/Game-market-analysis">Прогноз продаж в интернет-магазине</a></td>
  <td>numpy, pandas, scipy, matplotlib, seaborn</td>
  <td>На основании доступных данных о продажи игр нам нужно выявить определяющие успешность игры закономерности. Это позволит сделать ставку на потенциально популярный продукт и спланировать рекламные кампании.</td>
  <td>Завершен</td>
</tr>

<tr>
  <td><a href = "https://github.com/Shazy021/Oil_well">Выбор локации для скважины</a></td>
  <td>numpy, pandas, seaborn, matplotlib, sklearn, tqdm</td>
...
<tr>
  ...
  <td>numpy, pandas, seaborn, matplotlib, sklearn</td>
...
<tr>
  ...
  <td>numpy, pandas, seaborn, matplotlib, sklearn, catboost, lightgbm, своя реализация градиентного бустинга(SimpleBoost)</td>
...
<tr>
  ...
  <td>pandas, matplotlib, seaborn, tensorflow</td>
...
<tr>
  ...
  <td>numpy, pandas, seaborn, matplotlib, sklearn, tqdm, re, nltk, lightgbm, для решения проблемы написал класс реализующий все этапы предобработки и классификацию комментариев (токсичный/не токсичный)</td>
...
<tr>
  ...
  <td>numpy, pandas, seaborn, matplotlib, sklearn, catboost, lightgbm, своя реализация градиентного бустинга(SimpleBoostReg)</td>
